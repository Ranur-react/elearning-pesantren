        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="card card-info">
              ...
              <form class="form-horizontal" action="<?php echo site_url('latihan/update')?>" method="post">
                <div class="card-body">
                  <div class="form-group row">
                    <label class="col-sm-4 col-form-label">Id latihan</label>
                    <div class="col-sm-8">
                      <label class="text-success"><?php echo $b['id_ujian'];?></label>
					  <input type="hidden" name="id" value="<?php echo $b['id_ujian'];?>"/>
                    </div>
                  </div>
				  <div class="form-group row">
                    <label class="col-sm-4 col-form-label">Tgl. Mulai</label>
                    <div class="col-sm-8">
                      <input type="datetime-local" value="<?php $date = strtotime($b['tgl_mulai']); echo date('Y-m-d\TH:i', $date); ?>" name="tglmulai" required oninvalid="this.setCustomValidity('Tgl.Mulai tidak boleh kosong')" oninput="setCustomValidity('')" class="form-control" />
                    </div>
                  </div>
				  <div class="form-group row">
                    <label class="col-sm-4 col-form-label">Tgl.Selesai</label>
                    <div class="col-sm-8">
					  <input type="datetime-local" value="<?php $date = strtotime($b['tgl_selesai']); echo date('Y-m-d\TH:i', $date); ?>" required oninvalid="this.setCustomValidity('Tgl.Selesai tidak boleh kosong')" oninput="setCustomValidity('')" name="tglselesai" class="form-control" />
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
              ...
              <!-- form start -->
                <div class="card-body">
				  ...
				  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="number" required oninvalid="this.setCustomValidity('Waktu pengerjaan tidak boleh kosong')" oninput="setCustomValidity('')" value="<?php echo $b['waktu'];?>" name="waktu" class="form-control" />
                    </div>
              ...
              <!-- form start -->
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" value="<?php echo $b['nama_ujian']?>" required oninvalid="this.setCustomValidity('Judul tidak boleh kosong')" oninput="setCustomValidity('')" name="judul" class="form-control" />
                    </div>
                  </div>
                 </div>
                <!-- /.card-body -->
