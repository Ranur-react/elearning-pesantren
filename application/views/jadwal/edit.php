              ...
              <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo site_url('siswa/update')?>" method="post">
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" value="<?php echo $b['nis'];?>" name="nis" required oninvalid="this.setCustomValidity('NISN tidak boleh kosong')" oninput="setCustomValidity('')" placeholder="NISN">
                    </div>
                  </div>
                  <div class="form-group row">
